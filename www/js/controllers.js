...
/////////////////////////Search modal
        ...
        $scope.searchStocks = function () {
            if(searchMarket == "malaysia")
                $scope.loadSearchStocks("https://api.backand.com:443/1/objects/KLSE", {AnonymousToken: '8a9a114f-f851-4a3a-aae6-0aa0119c1acc'});
            else if(searchMarket == "nasdaq")
                $scope.loadSearchStocks("https://api.backand.com:443/1/objects/NASDAQ", {AnonymousToken: '1605dc7b-3afd-44a7-9233-509d4e64925c'});
            else if(searchMarket == "nyse")
                $scope.loadSearchStocks("https://api.backand.com:443/1/objects/nyse", {AnonymousToken: '8a9a114f-f851-4a3a-aae6-0aa0119c1acc'});

        };

        $scope.loadSearchStocks = function (url, headers) {
            $ionicLoading.show();
