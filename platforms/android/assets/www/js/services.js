...
//
//adds functionality to watch list
.factory('$watcherFactory', [function () {
    var toReturn = {
        addToWatchList: function (stockIndex, stockMarket) {
            //empty list check
            if(window.localStorage.getItem('stockWatchList') == null)
                window.localStorage.setItem('stockWatchList', JSON.stringify({}));
            //temp list var-object
            var tList = JSON.parse(window.localStorage.getItem('stockWatchList'));
            //add to temp list
            tList[stockIndex+stockMarket] = {index: stockIndex, market: stockMarket};
            //back to the list after adding the new element
            window.localStorage.setItem('stockWatchList', JSON.stringify(tList));
        },
        removeFromWatchList: function (stockIndex, stockMarket) {
            //empty list check
            if(window.localStorage.getItem('stockWatchList') == null)
                window.localStorage.setItem('stockWatchList', JSON.stringify({}));
            //temp list var-object
            ...
            tList[stockIndex+stockMarket] = null;
            //back to the list after removing the element
            window.localStorage.setItem('stockWatchList', JSON.stringify(tList));
        },
        isInWatchList: function (stockIndex, stockMarket) {
            //empty list check
            if(window.localStorage.getItem('stockWatchList') == null)
                window.localStorage.setItem('stockWatchList', JSON.stringify({}));
            //temp list var-object
            var tList = JSON.parse(window.localStorage.getItem('stockWatchList'));
            //check in temp list
            if(typeof tList[stockIndex+stockMarket] === "undefined" || tList[stockIndex+stockMarket] == null)
                return false;
            else
                return true;
        },
        getWatchList: function () {
            ...
            if(window.localStorage.getItem('stockWatchList') == null)
                window.localStorage.setItem('stockWatchList', JSON.stringify({}));
            return (    JSON.parse(window.localStorage.getItem('stockWatchList'))   );
        }
    };
